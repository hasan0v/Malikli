  ...
  return (
    <div className="max-w-4xl mx-auto">
      <div className="text-center mb-12">
        <h1 className="text-3xl font-bold mb-2">About malikli1992</h1>
        <p className="text-gray-600">Exclusive drops, limited editions, and unique designs</p>
      </div>
      ...
      <div className="bg-indigo-50 p-8 rounded-lg mb-12">
        ...
        <div className="grid md:grid-cols-3 gap-8">
          <div className="text-center">
            <div className="bg-indigo-600 text-white w-12 h-12 rounded-full flex items-center justify-center text-xl font-bold mx-auto mb-4">1</div>
            <h3 className="font-semibold mb-2">Stay Informed</h3>
            <p className="text-gray-600">Follow our upcoming drops and set reminders for products you're interested in.</p>
          </div>
          <div className="text-center">
            <div className="bg-indigo-600 text-white w-12 h-12 rounded-full flex items-center justify-center text-xl font-bold mx-auto mb-4">2</div>
            <h3 className="font-semibold mb-2">Be Ready</h3>
            <p className="text-gray-600">Products drop at the scheduled time and are available on a first-come, first-served basis.</p>
          </div>
          <div className="text-center">
            ...
            <p className="text-gray-600">Once a product is sold out, it may not be available again. Catch your favorite items before they're gone!</p>
          </div>
        </div>
      </div>
